      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {links.map((link) => (
          <a
            key={link.label}
            href={link.href}
            className="flex items-center p-4 border border-gray-200 bg-slateBlue bg-opacity-10 rounded-lg shadow hover:bg-slateBlue hover:text-white hover:rotate-6 transition"
